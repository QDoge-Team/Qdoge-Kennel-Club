...
import { fetchQSwapTransactions, type QSwapTransaction } from "@/services/backend.service";
...
const EpochRangeQswapTransactions: React.FC<{ startEpoch: number; endEpoch: number; searchTerm?: string; connectedWallet?: string | null }> = ({ startEpoch, endEpoch, searchTerm = "", connectedWallet = null }) => {
  ...
  useEffect(() => {
    setIsLoading(true);
    setError(null);
    // Fetch all transactions and filter by epoch range on client side
    fetchQSwapTransactions(0, 1000)
  ...
  return (
    <div className="flex flex-col w-full h-full gap-3">
      <div className="flex items-center justify-between">
        <span className="text-sm md:text-base font-semibold">Epochs {startEpoch}~{endEpoch} Qswap QDOGE Transactions</span>
...
export default EpochRangeQswapTransactions;
